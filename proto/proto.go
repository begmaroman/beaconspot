...
//go:generate protoc -I $GOPATH/src/github.com/prysmaticlabs/ethereumapis --proto_path=$GOPATH/src:. --go_out=plugins=grpc:$GOPATH/src $GOPATH/src/github.com/begmaroman/beaconspot/proto/beaconspot/beaconspot.proto
