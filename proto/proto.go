...
//go:generate protoc -I $GOPATH/src/github.com/prysmaticlabs/ethereumapis --proto_path=$GOPATH/src:. --go-grpc_out=$GOPATH/src --go_out=$GOPATH/src $GOPATH/src/github.com/begmaroman/beaconspot/proto/beaconspot/beaconspot.proto
